...
> across common/domain/application/infra/listener/wallet and skips 13 opt-in integration/live tests when Docker or live dependency variables are
...
> execution webhooks with dead-letter replay/ignore workflow, Coinbase Commerce REST-capable channel with no-key stub fallback and opt-in live smoke coverage,
...
| P3 (Testing) | 2 | Unit tests, Integration tests | 🟡 Unit tests (205 passing locally) · 🟡 Integration/live tests present, 13 skipped locally without Docker/live env |
| **Total** | **19** | | |
