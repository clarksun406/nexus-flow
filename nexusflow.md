...
> Current local verification (2026-06-14): `mvn -pl flow-api,flow-cashier -am test` runs 242 passing tests
...
| P3 (Testing) | 2 | Unit tests, Integration tests | 🟡 Unit tests (242 passing locally) · 🟡 Integration/live tests present, 14 skipped locally without Docker/live env |
| **Total** | **19** | | |
